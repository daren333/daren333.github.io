...
pattern. In this case, the pattern we are searching for is "20\\d{2}" aka the exact number "20" followed by exactly 
two additional 
digits ("\\d{2}"). Whenever that group of characters is found, it will replace those characters with the input year. 
For more 
